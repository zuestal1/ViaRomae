...
async function seedPrototype() {
  ...
  try {
    ...
    const testPlayers = [
      { id: IDS.player1, accountId: IDS.account1, playerName: 'Spieler 1', playerClass: 'swiss_guard' as const },
      { id: IDS.player2, accountId: IDS.account2, playerName: 'Spieler 2', playerClass: 'condottiere' as const },
    ];
