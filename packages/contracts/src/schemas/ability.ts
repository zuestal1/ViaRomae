...
export const ABILITY_DEFINITIONS = Object.freeze({
  ...
  "gardist.schildwall": define({ id: "gardist.schildwall", displayName: "Schildwall", class: "GARDIST", description: "Alle aktiven Teammitglieder erleiden 30 % weniger eingehenden Schaden.", allowedTargetTypes: ["ALL_ACTIVE_ALLIES"], conditions: [{ kind: "ALWAYS" }], effect: { kind: "TEAM_DAMAGE_REDUCTION", percent: 30 }, duration: "Eine gegnerische Runde", cooldownRounds: 3, resolutionRule: "Wird auf jeden aktiven Verbündeten angewendet und bei Ende der gegnerischen Runde entfernt.", passive: false }),
